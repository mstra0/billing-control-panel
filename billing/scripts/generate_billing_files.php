...
$_sqlite_db = null;
$_base_dir = dirname(__DIR__);

function sqlite_db()
{
    global $_sqlite_db, $_base_dir;
    if ($_sqlite_db === null) {
        $_sqlite_db = new SQLite3($_base_dir . "/test_shared/control_panel.db");
    }
    return $_sqlite_db;
}
...
$generated_dir = $_base_dir . "/test_shared/generated";
$archive_dir = $_base_dir . "/test_shared/archive";
