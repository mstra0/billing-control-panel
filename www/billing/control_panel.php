...
// Base path for billing data directories (test_shared, default_shared, scripts)
$_billing_data_dir = dirname(dirname(__DIR__)) . "/billing";
...
$_env_configs = [
    ...
    "default" => [
        "shared_base_path" => $_billing_data_dir . "/default_shared",
        "default_mock_mode" => false,
        "db_path" => $_billing_data_dir . "/default_shared/control_panel.db",
        "remote_db_host" => "",
        "remote_db_port" => 3306,
        "remote_db_name" => "",
        "remote_db_user" => "",
    ...
    "dev" => [
        "shared_base_path" => $_billing_data_dir . "/test_shared",
        "default_mock_mode" => true,
        "db_path" => $_billing_data_dir . "/test_shared/control_panel.db",
        "remote_db_host" => "",
        "remote_db_port" => 3306,
        "remote_db_name" => "",
        "remote_db_user" => "",
